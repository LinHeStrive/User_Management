				...
				<div class="content-wrapper">
					...
					<div class="page-header">
						...
						<nav aria-label="breadcrumb">
							<ul class="breadcrumb">
								<li class="breadcrumb-item active" aria-current="page"><span></span>概览
									<i
					...
					<div class="row">
						<div class="col-md-4 stretch-card grid-margin">
							<div class="card bg-gradient-danger card-img-holder text-white">
								<div class="card-body">
									<img src="${APP_PATH }/model/images/dashboard/circle.svg"
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table class="table">
											...
											<tbody>
												<tr>
													<td><img src="${APP_PATH }/model/images/faces/face1.jpg" class="mr-2"
												...
												<tr>
													<td><img src="${APP_PATH }/model/images/faces/face2.jpg" class="mr-2"
												...
												<tr>
													<td><img src="${APP_PATH }/model/images/faces/face3.jpg" class="mr-2"
												...
												<tr>
													<td><img src="${APP_PATH }/model/images/faces/face4.jpg" class="mr-2"
					...
					<div class="row">
						<div class="col-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">社区活动</h4>
									<div class="d-flex">
										<div
											class="d-flex align-items-center mr-4 text-muted font-weight-light">
											<i class="mdi mdi-account-outline icon-sm mr-2"></i> <span>小明</span>
										</div>
										<div
											class="d-flex align-items-center text-muted font-weight-light">
											<i class="mdi mdi-clock icon-sm mr-2"></i> <span>2019年12月
												10号</span>
										</div>
									</div>
									<div class="row mt-3">
										<div class="col-6 pr-1">
											<img src="${APP_PATH }/model/images/dashboard/active1.jpg"
												class="mb-2 mw-100 w-100 rounded" alt="image"> <img
												src="${APP_PATH }/model/images/dashboard/active4.jpg"
												class="mw-100 w-100 rounded" alt="image">
										</div>
										<div class="col-6 pl-1">
											<img src="${APP_PATH }/model/images/dashboard/active2.jpg"
												class="mb-2 mw-100 w-100 rounded" alt="image"> <img
												src="${APP_PATH }/model/images/dashboard/active3.jpg"
												class="mw-100 w-100 rounded" alt="image">
										</div>
									</div>
									<div class="d-flex mt-5 align-items-top">
										<img src="${APP_PATH }/model/images/faces/face3.jpg"
											class="img-sm rounded-circle mr-3" alt="image">
										<div class="mb-0 flex-grow">
											<h5 class="mr-2 mb-2">一只小可爱</h5>
											<p class="mb-0 font-weight-light">大爷大妈们真有活力。☺</p>
										</div>
										<div class="ml-auto">
