								...
								<div class="card">
									<div class="card-body">
										...
										<table class="table table-bordered" id="user_table">
											...
											<tbody>
												<c:forEach items="${pageInfo1.list}" var="user">
												        <tr>
												           <td ><input id=${user.id } type='checkbox' class='check_item'/></td>
												           <td><img src="${APP_PATH }/model/images/faces/${user.pic}"></img></td>
												           <td>${user.name }</td>
												           <td>${user.username }</td>
												           ...
												           <td>
												               <button id="update_user_btn" class="btn btn-gradient-primary btn-sm" update-id=${user.id } update-name=${user.username }>修改</button>
												               <button id="to_user_btn" class="btn btn-outline-dark btn-sm" touser-id=${user.id }>发送</button>
												           </td>
												        </tr>
												</c:forEach>
